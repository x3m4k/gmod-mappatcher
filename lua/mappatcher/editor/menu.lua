...
surface.CreateFont("MapPatcherGenericShadow", {
  font = "Helvetica",
  size = 16,
  weight = 1000,
  shadow = true,
...
function PANEL:Init()
  ...
  meshes_panel:SetSize(212, self:GetTall() - (30 + 5) - 5)
  ...
  tools_list:SetSize(187, self:GetParent():GetTall())
  ...
  info_panel:SetSize(self:GetWide() - (217 + 100 + 5) - 10, 100)
  info_panel:SetPos(217 + 100 + 10, 35)
  ...
  button_panel:SetPos(217 + 5, self:GetTall() - 70)
  ...
  object_list_scroll:SetPos(217 + 5, 140)
  ...
  object_panel:SetPos(417 + 10, 140)
...
function PANEL:UpdateMenu()
  ...
  self.info_richtext:SetText(tool_class.Description or "#mappatcher.tools.no_description")
  timer.Simple(0, function()
    self.info_richtext:GotoTextStart()
  end)
  ...
  for object_id, object in pairs(MapPatcher.Objects) do
    ...
    function button:DoRightClick()
      MapPatcher.Editor.ContextMenu(object)
    end
